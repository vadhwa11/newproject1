...
public class HMSUtil extends ServletRequestUtils {
 ...
 public static int calculateAgeNoOfYear(Date dob ) {
	...
	/*
	 * public static String getFullName(MasEmployee emp) { String patientName = "";
	 * if (emp.getFirstName() != null) { patientName = emp.getFirstName(); }
	 * 
	 * if (emp.getMiddleName() != null) { patientName = patientName + " " +
	 * emp.getMiddleName(); } if (emp.getLastName() != null) { patientName =
	 * patientName + " " + emp.getLastName();
	 * 
	 * } return patientName; }
	 */
