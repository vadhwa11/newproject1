...
public class MasEmployeeCategory implements Serializable {
	...
	@Id
	@SequenceGenerator(name="MAS_EMPLOYEE_CATEGORY_EMPLOYEECATEGORYID_GENERATOR" )
	...
	private BigDecimal employeeCategoryCode;
	...
	public BigDecimal getEmployeeCategoryCode() {
		return this.employeeCategoryCode;
	}

	public void setEmployeeCategoryCode(BigDecimal employeeCategoryCode) {
