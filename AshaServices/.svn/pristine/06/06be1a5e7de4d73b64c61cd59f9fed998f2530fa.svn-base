...
public class MasAdministrativeSex implements Serializable {
	...
	@Id
	@SequenceGenerator(name="MAS_ADMINISTRATIVE_SEX_ADMINISTRATIVESEXID_GENERATOR", sequenceName="ADMINISTRATIVE_SEX_ID")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="MAS_ADMINISTRATIVE_SEX_ADMINISTRATIVESEXID_GENERATOR")
