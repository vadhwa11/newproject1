            ...
            <ul class="nav">
                <li class="active">
					<a href="#" data-target="#item1" data-toggle="collapse" data-parent="#stacked-menu"> <i class="ti-user"></i>
                        <p>Registration<span class="caret arrow"></span></p>
                    </a>
						<ul class="nav child_menu nav-stacked collapse left-submenu" id="item1">
							<li><a href="${pageContext.request.contextPath}/v0.1/dashboard/user" style="font-weight:900;margin-left: 50px"><span></span>Add New Patient</a></li>
							<li><a href="${pageContext.request.contextPath}/v0.1/dashboard/managemerchant" style="font-weight:900;margin-left: 50px">Existing Patient</a></li>
						</ul>
					</li>
                <li class="active">
					<a href="#" data-target="#item1" data-toggle="collapse" data-parent="#stacked-menu"> <i class="ti-user"></i>
                        <p>Reception<span class="caret arrow"></span></p>
                    </a>
						<ul class="nav child_menu nav-stacked collapse left-submenu" id="item1">
							<li><a href="${pageContext.request.contextPath}/v0.1/dashboard/user" style="font-weight:900;margin-left: 50px"><span></span>Book Appointment</a></li>
							<li><a href="${pageContext.request.contextPath}/v0.1/dashboard/managemerchant" style="font-weight:900;margin-left: 50px">Patients Waiting List</a></li>
						</ul>
					</li>
				...
				<li class="active">
					<a href="#" data-target="#item1" data-toggle="collapse" data-parent="#stacked-menu"> <i class="ti-user"></i>
                        <p>OPD<span class="caret arrow"></span></p>
                    </a>
						<ul class="nav child_menu nav-stacked collapse left-submenu" id="item1">
                ...
                <li class="active">
					<a href="#" data-target="#item1" data-toggle="collapse" data-parent="#stacked-menu"> <i class="ti-user"></i>
                        <p>Lab<span class="caret arrow"></span></p>
                    </a>
						<ul class="nav child_menu nav-stacked collapse left-submenu" id="item1">
							<li><a href="${pageContext.request.contextPath}/v0.1/dashboard/user" style="font-weight:900;margin-left: 50px"><span></span>Add New Emp</a></li>
							<li><a href="${pageContext.request.contextPath}/v0.1/dashboard/managemerchant" style="font-weight:900;margin-left: 50px">Logs</a></li>
                    ...
                    <div class="col-lg-12 col-md-7">
                        <div class="card">
							...
							<div class="row">
                                    ...
                                    <input type="button" value="Login Page" name="Login Page" onclick="openPage('registration.jsp')"/>
