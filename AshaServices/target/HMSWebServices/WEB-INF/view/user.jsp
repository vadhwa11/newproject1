            ...
            <ul class="nav">
                ...
                <li class="active">
					<a href="#" data-target="#item1" data-toggle="collapse" data-parent="#stacked-menu"> <i class="ti-user"></i>
                        <p>MERCHANTS & LOGS<span class="caret arrow"></span></p>
                    </a>
						<ul class="nav child_menu nav-stacked collapse left-submenu" id="item1">
							...
							<li><a href="${pageContext.request.contextPath}/v0.1/dashboard/managemerchant" style="font-weight:900;margin-left: 50px">Merchants & Logs</a></li>
						</ul>
					</li>
                ...
                <li>
                  <a href="${pageContext.request.contextPath}/v0.1/dashboard/viewtrackpage">
                        <i class="ti-text"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-7">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="${pageContext.request.contextPath}/v0.1/dashboard/registration">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Company*</label>
                                                <input name="company" type="text" class="form-control border-input" enabled placeholder="Company" value="" required />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Mobile No.*</label>
                                                <input name="mobile" type="tel" min="10"  maxlength="10" class="form-control border-input" placeholder="Mobile No." value="" required />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Email address*</label>
                                                <input name="email" type="email" class="form-control border-input" placeholder="Email" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="owner" type="text" class="form-control border-input" placeholder="Owner" value="" required />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Merchant Name*</label>
                                                <input name="merchant" type="text" class="form-control border-input" placeholder="Merchant Name" value="" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Address*</label>
                                                <input name="address" type="text" class="form-control border-input" placeholder="Address" value="" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                             <div class="form-group">
                                                <label>Ip(s)*</label>
                                                <input name="ip" type="text" class="form-control border-input" placeholder="192.XXX.4.148,192.168.14.XXX" value="" required />
                                            </div> 
                                        </div>
                                        <div class="col-md-4">
                                             <div class="form-group">
                                                <label>Role*</label>
                                                <input name="role" type="text" class="form-control border-input" placeholder="Role" value="USER" required />
                                            </div> 
                                        </div>
                                        <!-- <div class="col-md-4">
                                            <div class="form-group">
							...
							<div class="row">
                                        <div class="col-md-4">
                                             <div class="form-group">
                                                ...
                                                <input name="monvol" type="text" class="form-control border-input" placeholder="Monthly Transaction Volume*" value="" required />
                                            </div> 
                                        </div>
                                        <div class="col-md-4">
                                             <div class="form-group">
                                                <label>eKYC or Authentication Purpose(s)*</label>
                                                <input name="purpose" type="text" class="form-control border-input" placeholder="eKYC or Authentication Purpose(s)*" value="" required>
                                            </div> 
                                        </div>
                                        <!-- <div class="col-md-4">
                                            <div class="form-group">
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>, made with <i class="fa fa-heart heart"></i> by <a href="https://www.filegstnow.com/"> JK Technosoft Limited.</a>
                </div>
            </div>
        </footer>
