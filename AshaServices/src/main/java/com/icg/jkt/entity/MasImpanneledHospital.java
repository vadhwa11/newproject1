...
public class MasImpanneledHospital implements Serializable {
	...
	@Id
	@SequenceGenerator(name="MAS_IMPANNELED_HOSPITAL_SEQ", sequenceName="MAS_IMPANNELED_HOSPITAL_SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="MAS_IMPANNELED_HOSPITAL_SEQ")
