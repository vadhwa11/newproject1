			...
			<div class="content">
                ...
                <h6 style=" background: grey;padding: 7px 0px 8px 12px;border-radius: 1px;">APPOINTMENT SETUP</h6>
							...
							<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="service" class="col-sm-3 col-form-label">OPD
	...
	%>
								<tr>
									...
									<td><input type="text" size=8 id="tokenStart<%=inc%>"
										...
										id="breakToTime2"
										onkeyup="setOnlineToken('tokenStart<%=inc%>','totalToken<%=inc%>','tokenInterval<%=inc%>','totalOnlineToken<%=inc%>','1');" /></td>
									...
									<td><input type="text" size=8 id="totalToken<%=inc%>"
										...
										onkeyup="setOnlineToken('tokenStart<%=inc%>','totalToken<%=inc%>','tokenInterval<%=inc%>','totalOnlineToken<%=inc%>','1');"
										MAXLENGTH="8" id="breakToTime3" /></td>

									<td><input type="text" size=8
										id="totalOnlineToken<%=inc%>" name="TotalOnlineToken"
										onkeyup="setOnlineToken('tokenStart<%=inc%>','totalToken<%=inc%>','tokenInterval<%=inc%>','totalOnlineToken<%=inc%>','2');"
										MAXLENGTH="8" id="breakToTime3" /></td>
