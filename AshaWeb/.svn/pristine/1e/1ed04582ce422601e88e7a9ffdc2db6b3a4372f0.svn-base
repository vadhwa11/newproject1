...
function searchRankList(){
	...
	var nPageNo=1;
	var url = "getAllRankDetails";
	var data =  {"PN":nPageNo, "rankName":rankName};//"PN="+nPageNo+"cmdName="+cmdName;
	var bClickable = true;
	GetJsonData('tblListOfRank',data,url,bClickable);
	ResetFrom();
}
...
function addRankDetails(){
	...
	if(document.getElementById('selectEmpCat').value==""){
		alert("Please Enter the Employee Category");
		return false;
	}
	var params = {
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-menu-right profile-dropdown ">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="text-overflow"><small>Welcome ! Rank Master</small> </h5>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title float-left">Rank Master</h4>
                                        ...
                                        <div class="col-md-8">
                                            <form class="form-horizontal" id="searchRankForm" name="searchRankForm" method="" role="form">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-2">
                                                        <button type="button" class="btn  btn-primary" onclick="searchRankList();">Search</button>
                                                    </div>
                                                </div>
                                            </form>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" id="rankCode" name="rankCode" placeholder="Rank Code" onkeypress=" return validateText('rankCode',7);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" id="rankName" name="rankName" placeholder="Rank Name" onkeypress="return validateTextField('rankName',30)">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <label for="recordoffice" class="col-sm-4 col-form-label inner_md_htext">Employee Category <span style="color:red">*</span> </label>
