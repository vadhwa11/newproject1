...
function rowClick(sId,sCode,sName,sStatus){	
	...
	$j('#btnAddSample').attr("disabled", true);
	$j('#sampleCode').attr('readonly', true);
	
}

function searchSampleList(){	
	if(document.getElementById('searchSample').value == "" || document.getElementById('searchSample') == null){
		 alert("Plese Enter the Sample Name");
		 return false;
	 }
...
function updateSample(){	
	...
	var params = {
		    ...
		    SendJsonData(url,params);
		    $j('#updateBtn').attr("disabled", true);
			$j('#btnAddSample').attr("disabled", false);
			$j('#sampleCode').attr('readonly', true);
			ResetFrom();
}
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-menu-right profile-dropdown ">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="text-overflow"><small>Welcome ! Sample Container Master</small> </h5>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title float-left">Sample Container Master</h4>
                                            ...
                                            <form id="addSampleForm" name="addSampleForm" method="">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                        <div class="col-sm-5">
                                                            <label for="Sample Code" class=" col-form-label inner_md_htext" >Sample Code <span style="color:red">*</span> </label>
                                                            </div>
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" id="sampleCode" name="sampleCode" placeholder="Sample Code" onkeypress=" return validateText('sampleCode',7);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                        <div class="col-sm-5">
                                                            <label for="service" class="col-form-label inner_md_htext">Sample Name <span style="color:red">*</span> </label>
                                                            </div>
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" id="sampleDescription" name="sampleDescription" placeholder="Sample Name" onkeypress="return validateTextField('sampleDescription',30)">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-5">
                                            <form>
                                                <div class="button-list">
                                                    ...
                                                    <button id="btnActive" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateSampleStatus();">Active</button>
                                      				<button id="btnInActive" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateSampleStatus();">InActive</button>
