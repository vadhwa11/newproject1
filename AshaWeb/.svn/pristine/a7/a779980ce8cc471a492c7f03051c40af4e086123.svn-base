                                        ...
                                        <div class="col-md-5">
                                            <form>
                                                <div class="button-list">
                                                    ...
                                                    <button id="btnActive" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateMainChargecodeStatus();">Active</button>
                                      				<button id="btnInActive" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateMainChargecodeStatus();">InActive</button>
