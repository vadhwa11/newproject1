                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded=false>
								...
								<li><a href="${pageContext.request.contextPath}/registration/showUploadPatientDocument">Upload Patient Document</a></li>
								<li><a href="${pageContext.request.contextPath}/registration/showMIReport">MI Report</a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="${pageContext.request.contextPath}/v0.1/master/regionMaster">Region Master</a></li>
                                ...
                                <li><a href="${pageContext.request.contextPath}/v0.1/master/usersMaster">User Master </a></li>
                                <li><a href="${pageContext.request.contextPath}/v0.1/master/roleMaster">Role Master </a></li>
                                <li><a href="${pageContext.request.contextPath}/v0.1/master/rangeMaster">Range Master </a></li>
