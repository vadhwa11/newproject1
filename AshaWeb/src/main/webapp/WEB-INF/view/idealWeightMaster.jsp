...
function executeClickEvent(idealWeightId,data)
{
	...
	rowClick(idealWtId,idealWtFromAge,idealWtToAge,idealWtFromHeight,idealWtToHeight,idealWtWeight,idealWtStatus);
}

function rowClick(idealWtId,idealWtFromAge,idealWtToAge,idealWtFromHeight,idealWtToHeight,idealWtWeight,idealWtStatus){	
		
	document.getElementById("").value = empanelledHospCode;
	document.getElementById("").value = empanelledHospName;
	document.getElementById("").value = empanelledHospAddress;
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title float-left">Ideal Weight Master</h4>

                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item active"><a href="#">Home</a></li>
                                     <li class="breadcrumb-item  active"><a href="#">Master</a></li>  
                                    <li class="breadcrumb-item active">Ideal Weight Master</li>
                                </ol>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group row">                                                        
                                                            <label for="recordoffice" class="col-sm-5 col-form-label inner_md_htext">Height <span style="color:red">*</span></label>  
                                                             <div class="col-md-7">                                                          
                                                            <input type="text" class="form-control" id="height" name="height" placeholder="Height" onkeypress="return validateText('height',3);"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
