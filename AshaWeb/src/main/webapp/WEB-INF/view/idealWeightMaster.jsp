...
function GetAllIdealWeight(MODE){	
	var genderId = jQuery('#sGenderList').find('option:selected').val();
	 var idealWeightId=0;
	 if(MODE == 'ALL'){
...
/* function searchIdealWeightList(){	
	if(document.getElementById('sGenderList').value == "" || document.getElementById('sGenderList') == null){
	 ...
	 var administrativeSexId= jQuery("#sGenderList").val();
	 		alert("genderId :: "+administrativeSexId);
		var nPageNo=1;
		var url = "getAllIdealWeight";
...
function addIdealWeightDetails(){
	...
	if(document.getElementById('selectGender').value=="0" || document.getElementById('selectGender')==null){
		alert("Please Select Gender");
		return false;
	}
	 
	if(document.getElementById('selectHeight').value=="0" || document.getElementById('selectHeight')==null){
		alert("Please Select the Height");
		return false;
	}
	
	if(document.getElementById('selectAge').value=="0" || document.getElementById('selectAge')==null){
...
{	
	...
	if(document.getElementById('selectHeight').value=="0" || document.getElementById('toHeight')==null){
		alert("Please Select the Height");
		return false;
	}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                               ...
                                               <div class="form-group row">
                                                    <label class="col-2 col-form-label">Gender<span style="color:red">*</span></label>
                                                    <div class="col-4">                                                       
										...
										<div class="col-md-12">
											...
											<div class="btn-right-all">
														...
														<button type="button" id="updateBtn"
															class="btn  btn-primary " onclick="updateIdealWeight();">Update</button>
															
														<button id="btnActive" type="button"
															class="btn  btn-primary " onclick="updateIdealWeight();">Activate</button>
															
														<button id="btnInActive" type="button"
															class="btn btn-primary  " onclick="updateIdealWeight();">Deactivate</button>
