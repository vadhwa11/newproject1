 ...
 function searchOpdPreConsultationList()
{
	...
	var data = {"hospitalId": <%= hospitalId %>,"employeeId": <%=userId%>, "service_no":service_no,"patient_name":patient_name,"pageNo":"1","opdPre":"opdWait"};
	var bClickable = true;
 ...
 function getOpdPreConsultationList(MODE) { 	
	...
	if (service_no === undefined) {
 	...
 	<%-- var data = {"hospitalId": <%= hospitalID %>, "serviceNo":service_no,"patient_name":patient_name,"pageNo":nPageNo}; --%>
 	 	var data = {"hospitalId": <%= hospitalId %>,"employeeId": <%=userId%>,"pageNo":nPageNo,"opdPre":"opdWait","service_no":service_no,"patient_name":patient_name}; 
