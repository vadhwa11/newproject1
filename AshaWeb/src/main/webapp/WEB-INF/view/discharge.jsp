...
%>
	...
	function saveAdmissionDetail() {
		...
		if (discharge_date == '' || discharge_date == undefined) {
			...
			return;			
		}else if(new Date(discharge_date) < new Date(admission_date)){
			alert("Discharge Date can't be earlier than Admission Date");
			return;
		}else if(new Date(discharge_date) > new Date()){
	...
	function dateFormat(inputdate) {
		...
		var formated_date = daynmonth[0] + '/' + daynmonth[1] + '/'
				+ daynmonth[2];
										...
										<form>
											...
											<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-sm-7">
															<input type="text" class="form-control" id="admission_no" readonly>
														</div>
													</div>
												</div>
												<div class="col-md-4">
