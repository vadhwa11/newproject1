...
function GetCommandList(){		
 ...
 function executeClickEvent(unitId,data)
 {
 	...
 	for(j=0;j<data.data.length;j++){
 		if(unitId == data.data[j].unitId){
 			...
 			uName = data.data[j].unitName;
 			 uStatus = data.data[j].status;
 			uCommandId = data.data[j].cmdId;
 			uCommandName = data.data[j].commandName;
 			uType = data.data[j].unitType;
 			uTypeId = data.data[j].unitTypeId; 			
 			uAddress = data.data[j].unitAddress;
 			
 		}
 	}
 	rowClick(uId,uName, uAddress, uStatus, uCommandId, uCommandName, uType,uTypeId,uAddress);
 }
 
 function rowClick(uId,uName, uAddress, uStatus, uCommandId, uCommandName, uType,uTypeId,uAddress){
		document.getElementById("unitName").value = uName;	
		document.getElementById("unitAddress").value = uAddress;
		
		for(var j=0; j<comboArray.length;j++){				
			
			if(comboArray[j] == uCommandName){
				jQuery("#selectListOfCommand").val(uCommandId);
			}
		}
 ...
 function updateUnitMaster(){
	 ...
	 if(document.getElementById('sUnitTypList').value=="" || document.getElementById('sUnitTypList').value== null){
		...
		params = {
				...
				'commandId':jQuery('#selectListOfCommand').find('option:selected').val(),
 ...
 function addUnit(){
	...
	var uCommandId =  jQuery('#selectListOfCommand').find('option:selected').val();
	var unitTypId = jQuery('#sUnitTypList').find('option:selected').val();		 
	  var params = {
			
			 'unitName':jQuery('#unitName').val(),
			 'unitAddress':jQuery('#unitAddress').val(),
			 'commandId':uCommandId,
			 'unitTypeId':unitTypId
...
function search()
{
	if(document.getElementById('searchUnit').value == ""){
...
function generateReport()
{
	...
	document.searchUnitForm.action="${pageContext.request.contextPath}/report/generateUnitReport";
	document.searchUnitForm.method="POST";
	document.searchUnitForm.submit(); 
                                        ...
                                        <div class="col-md-8">
                                            <form class="form-horizontal" id="searchUnitForm" name="searchUnitForm" method="" role="form">
                                                <div class="form-group row">
                                                    <label class="col-3 col-form-label">Unit Name <span style="color:red">*</span></label>
                                                    <div class="col-4">                                                    
                                                               
                                                              <input type="text" name="searchUnit" id="searchUnit" class="form-control" id="inlineFormInputGroup" placeholder="Unit Name" onkeypress="return validateTextField('searchUnit',30,'Unit Name');">
                                        ...
                                        <div class="col-md-12">
                                            <form id="addUnitForm" name="addUnitForm" action="" method="POST">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="text" name="unitName" id="unitName" class="form-control" placeholder="Unit Name" onkeypress="return validateTextField('unitName',30,'Unit Name');">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="text" name="unitAddress" id="unitAddress" class="form-control" placeholder="Unit Address" onkeypress="return validateTextField('unitAddress',30,'Unit Address');">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <label for="recordoffice" class="col-sm-5 col-form-label inner_md_6text">Region Name <span style="color:red">*</span></label>
                                             ...
                                             <div class="form-group row">
                                                            ...
                                                            <label for="recordoffice" class="col-sm-5 col-form-label inner_m6_htext">Unit Type <span style="color:red">*</span></label>
									...
									<div class="row">
										...
										<div class="col-md-12">
											...
											<div class="btn-right-all">
														...
														<button type="button" id="addBtnUnit"
															class="btn  btn-primary " onclick="addUnit();">Add</button>
														<button type="button" id="updateBtn"
															class="btn  btn-primary " onclick="updateUnitMaster();">Update</button>
