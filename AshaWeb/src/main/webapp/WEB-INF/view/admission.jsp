...
%>
	...
	function saveAdmissionDetail() {
		...
		var referral_date = dateFormat($j('#referral_date').val());
		
		if (admission_date == '' || admission_date == undefined) {
			alert("Admission date must be selected");
			return;
		}else if(admission_date < referral_date){
								...
								<div class="row">
									<div class="col-md-12">
										<form>
											...
											<div class="row">
												<h4  class="service_htext">Admission Detail</h4>
											</div>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group row">
												...
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-sm-7">
															<input type="text" class="form-control" id="ward" onkeypress="return isNumber(event)">
														</div>
													</div>
												</div>											
												<div class="col-md-4">
