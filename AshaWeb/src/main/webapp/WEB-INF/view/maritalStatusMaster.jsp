                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title float-left">Marital Status Master</h4>
                                        ...
                                        <div class="col-md-5">
                                            <form>
                                                <div class="button-list">
                                                    ...
                                                    <button id="btnActive" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateMaritalStatusStatus();">Active</button>
                                      				<button id="btnInActive" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateMaritalStatusStatus();">InActive</button>
