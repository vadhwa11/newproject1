...
function addCmdDetails(){
	...
	if(document.getElementById('selectCmdType').value=="" || document.getElementById('selectCmdType').value==null){
		alert("Please Enter the Command Type");
		return false;
	} 
	var params = {
    ...
    <div id="wrapper">
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-menu-right profile-dropdown ">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="text-overflow"><small>Welcome ! Command Master</small> </h5>
                            </div>
        ...
        <div class="content-page">
            ...
            <div class="">
                ...
                <div class="internal_Htext">Command Master</div>
                                        ...
                                        <div class="col-md-8">
                                            <form class="form-horizontal" id="searchCommandForm" name="searchCommandForm" method="" role="form">
                                                <div class="form-group row">
                                                    <label class="col-3 col-form-label inner_md_htext">Command Name <span style="color:red">*</span></label>
                                                    <div class="col-4">
                                                        <div class="col-auto">
                                                            <label class="sr-only" for="inlineFormInputGroup">Command Name</label>
                                                            <div class="input-group mb-2">
                                                                <!-- <div class="input-group-prepend">
                                                                    <div class="input-group-text">&#128269;</div>
                                                                </div> -->
                                                                <input type="text" name="searchCommand" id="searchCommand" class="form-control" id="inlineFormInputGroup" placeholder="Command Name" onkeypress="return validateTextField('searchCommand',30);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
					...
					<!-- <table class="table table-striped table-hover jambo_table"> -->
                                    ...
                                    <table class="table table-hover table-bordered">
                                        <thead class="bg-success" style="color:#fff;">
                                            <tr>
                                                <th id="th2" class ="inner_md_htext">Command Code</th>
                                                <th id="th3" class ="inner_md_htext">Command Name</th>
                                                <th id="th4" class ="inner_md_htext"> Command Type </th>
                                            ...
                                            <form id="addCommandForm" name="addCommandForm" method="">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                        <div class="col-sm-4">
                                                            <label for="Command Code" class=" col-form-label inner_md_htext" >Command Code <span style="color:red">*</span></label>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="commandCode" name="commandCode" placeholder="Command Code" onkeypress="return validateText('commandCode',7);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                        <div class="col-sm-4">
                                                            <label for="service" class="col-form-label inner_md_htext">Command Name <span style="color:red">*</span></label>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="commandName" name="commandName" placeholder="Command Name" onkeypress="return validateTextField('commandName',30);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <label for="recordoffice" class="col-sm-4 col-form-label inner_md_htext">Command Type<span style="color:red">*</span></label>
                                        ...
                                        <div class="col-md-5">
                                            <form>
                                                <div class="button-list">
                                                    ...
                                                    <button type="button" id="btnAddCommand" class="btn btn-primary  " onclick="addCmdDetails();">Add</button>
                                                    <button type="button" id ="updateBtn" class="btn btn-primary  " onclick="updateCmdDetails();">Update</button>
