...
{
	document.searchBloodGroupForm.action="${pageContext.request.contextPath}/report/generateBloodGroupReport";
	document.searchBloodGroupForm.method="POST";
	document.searchBloodGroupForm.submit(); 
                                       ...
                                       <div class="row">
											...
											<form class="form-horizontal" id="searchBloodGroupForm"
												...
												<div class="form-group row">
													<label class="col-3 col-form-label">Blood Group Name<span
                                            ...
                                            <form id="addBloodGroupForm" name="addBloodGroupForm" method="">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                        <div class="col-sm-5">
                                                            <label for="BloodGroup Code" class=" col-form-label inner_md_htext" >Blood Group Code <span style="color:red">*</span> </label>
                                                            </div>
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" id="bloodGroupCode" name="bloodGroupCode" placeholder="Blood Group Code" onkeypress=" return validateText('bloodGroupCode',3,'Blood Group Code');">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                        <div class="col-sm-5">
                                                            <label for="service" class="col-form-label inner_md_htext">Blood Group Name <span style="color:red">*</span> </label>
                                                            </div>
                                                            <div class="col-sm-7">
