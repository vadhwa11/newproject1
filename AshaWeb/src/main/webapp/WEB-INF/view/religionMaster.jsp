                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title float-left">Religion Master</h4>
                                        ...
                                        <div class="col-md-8">
                                            <form class="form-horizontal" id="searchReligionForm" name="searchReligionForm" method="" role="form">
                                                <div class="form-group row">
                                                    <label class="col-3 col-form-label inner_md_htext">Religion Name <span style="color:red">*</span> </label>
                                                    <div class="col-5">
                                                        <div class="col-auto">
                                        ...
                                        <div class="col-md-5">
                                            <form>
                                                <div class="button-list">
                                                    ...
                                                    <button type="button" id="btnAddReligion" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="addReligionDetails();">Add</button>
                                                    <button type="button" id ="updateBtn" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateReligion();">Update</button>
                                                    <button id="btnActive" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateReligionStatus();">Active</button>
                                      				<button id="btnInActive" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light" onclick="updateReligionStatus();">InActive</button>
